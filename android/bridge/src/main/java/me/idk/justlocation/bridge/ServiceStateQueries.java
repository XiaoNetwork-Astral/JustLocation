...
/** The outer method has already checked permissions, active subscriptions and location redaction. */
final class ServiceStateQueries {
    interface Source { Object replace(String packageName, int slot, Object authorized) throws Exception; }
    ...
    void install(TelephonyQueries.Installer installer) throws Exception {
        installer.install(query, call -> {
            ...
            return authorized == null ? null : source.replace((String) call.arguments[4],
