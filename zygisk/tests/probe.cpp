...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM*, void*) {
    ...
    if (!dladdr(reinterpret_cast<void*>(JNI_OnLoad), &self) ||
        !dlopen(self.dli_fname, RTLD_NOW | RTLD_NODELETE)) return JNI_ERR;
...
Java_me_idk_justlocation_bridge_RuntimeProbe_hook(JNIEnv* env, jclass, jobject target, jobject receiver, jobject callback) {
