    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (args.length > 1 && args[1].equals("bridge")) {
            ...
            PathClassLoader loader = new PathClassLoader(
                    System.getenv("SYSTEMSERVERCLASSPATH"), ClassLoader.getSystemClassLoader());
            var cached = Class.forName("com.android.internal.os.ZygoteInit")
                                 .getDeclaredField("sCachedSystemServerClassLoader");
            cached.setAccessible(true);
            cached.set(null, loader);
            require(bootstrap(args[0], Files.readAllBytes(Path.of(args[0], "classes.dex"))),
                    "production DEX bootstrap");
        ...
        callback.backup =
                hook(sample, callback, SampleHook.class.getMethod("callback", Object[].class));
        require(callback.backup != null, "install sample hook");
        require("hooked:original:probe".equals(sample.invoke(null, "probe")),
                "callback and original method");
        ...
        Class<?> multiplexer = Class.forName(
                "com.android.server.location.listeners.ListenerMultiplexer", false, loader);
        ...
        provider.getDeclaredMethod("getLastLocation",
                Class.forName("android.location.LastLocationRequest", false, loader), identity,
                int.class);
        provider.getDeclaredMethod("getCurrentLocation",
        ...
        Class<?> registrationBase =
                Class.forName(provider.getName() + "$Registration", false, loader);
        ...
        for (String nested :
                new String[] {"LocationRegistration", "GetCurrentLocationListenerRegistration"}) {
